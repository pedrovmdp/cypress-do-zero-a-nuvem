describe('Testando Duon', () => {
    ...
    it.only('indo até arquivo ged', () => {
        ...
        cy.get('#overlay_menu_104_0 > .p-menuitem-content > .p-menuitem-link').click() //clica em editar
        ...
        .selectFile('cypress/fixtures/black_Image.jpg', { force: true })
        .should( input=> {
